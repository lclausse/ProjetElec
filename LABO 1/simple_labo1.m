...
x1 = [xReceivers(1,1),xReceivers(1,1),xReceivers(1,1),...
      xReceivers(1,2),xReceivers(1,2),xReceivers(1,3)];
y1 = [xReceivers(2,1),xReceivers(2,1),xReceivers(2,1),...
      xReceivers(2,2),xReceivers(2,2),xReceivers(2,3)];
x2 = [xReceivers(1,2),xReceivers(1,3),xReceivers(1,4),...
      xReceivers(1,3),xReceivers(1,4),xReceivers(1,4)];
y2 = [xReceivers(2,2),xReceivers(2,3),xReceivers(2,4),...
      xReceivers(2,3),xReceivers(2,4),xReceivers(2,4)];
